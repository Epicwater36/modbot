...
if(senderID == "574745164220727296" || senderID == "617119885289324562"){
    ...
    else if(await message.content.startsWith("!unbanword")){
        const args = message.content.split(" ")
        const word = args[1]
        let deletedWord = removeWord(word)
        message.reply("You unbanned "+word)
    }   else if (await message.content.toLowerCase().startsWith("!banword")){
        const args = message.content.split(" ")
        const word = args[1]
        addWord(word)
